...
public class ButtonFactory {
    ...
    public ButtonFactory (CommandPromptDisplayBox commandBox,
                          MessageDisplayBoxObserver messageBox,
                          CommandHistoryBox historyDisplayBox,
                          TurtleGroupObserver turtleGroup,
                          UserInput userInputObservable) {
    ...
    public void createButtons () {
        ...
        HashMap<String, EventHandler<ActionEvent>> buttonEventHandle =
    ...
    private void uploadButtonEvent () {
        ...
        if (selectedFile != null) {
            ...
            myTurtleGroup
                    .setImage(new Image(getClass().getClassLoader().getResourceAsStream(fileName)));
            myMessageBox.setMessage(fileName + " uploaded");
        }
        else {
            if (selectedFile == null) {
    ...
    private void enterButtonEvent () {
        ...
        UserInputTransferObject ut =
                new UserInputTransferObject(myUserInputObservable.getCurrentLanguage(),
                                            myUserInputObservable.getUserInput());
        try {
